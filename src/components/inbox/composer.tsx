...
export function Composer({
  ...
  if (!conversation.windowOpen) {
    return (
      <div className="vidrio-fuerte shrink-0 border-t px-3 py-2.5">
  ...
  return (
    <div className="vidrio-fuerte relative shrink-0 border-t px-3 pb-2 pt-2">
      {programando && (
        <SchedulePopover
      ...
      <div className="flex items-end gap-2 rounded-lg border bg-background px-3 py-2 shadow-sm transition-shadow focus-within:border-brand focus-within:ring-[3px] focus-within:ring-brand-soft">
        <textarea
          ref={taRef}
