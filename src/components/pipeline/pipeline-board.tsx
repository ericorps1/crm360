...
export function PipelineBoard({
  ...
  return (
    <div className="flex h-full flex-col">
      <header className="vidrio-fuerte flex shrink-0 items-center justify-between gap-2 border-b px-3 py-1.5">
...
function StageColumn({
  ...
  return (
    <div
      ref={setNodeRef}
      className={cn(
        "vidrio flex h-full w-56 shrink-0 flex-col rounded-lg transition-shadow",
