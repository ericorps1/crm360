...
const globalForBus = globalThis as unknown as { __crm360Bus?: EventEmitter };

function getBus(): EventEmitter {
  if (!globalForBus.__crm360Bus) {
    const bus = new EventEmitter();
    bus.setMaxListeners(200);
    globalForBus.__crm360Bus = bus;
  }
  return globalForBus.__crm360Bus;
}
