...
import { isToneKey } from "@/lib/stage-colors";
...
const patchSchema = z.object({
  ...
  // Solo claves de la paleta cerrada: nada de hex libres desde el cliente.
  tone: z.string().refine(isToneKey, "Tono no válido").optional(),
});
  ...
  const updated = await db
    ...
    .set({
      ...
      ...(body.data.position !== undefined
        ...
        : {}),
      ...(body.data.tone !== undefined ? { tone: body.data.tone } : {}),
    })
    .where(
      scoped(
